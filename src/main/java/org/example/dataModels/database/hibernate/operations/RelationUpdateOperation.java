...
public class RelationUpdateOperation implements DataModel {
    ...
    public RelationUpdateOperation() {
    }

    public RelationUpdateOperation(String primaryName, String secondaryName, String basePackage) {
    ...
    public boolean equals(Object o) {
        ...
        RelationUpdateOperation that = (RelationUpdateOperation) o;
