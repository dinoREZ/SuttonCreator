...
public class RelationDaoHibernateImpl implements DataModel {
    ...
    public RelationDaoHibernateImpl(String primaryName, String secondaryName, String basePackage, List<Query> queries) {
    ...
    public String getOutputName() {
        return this.getPrimaryName() + this.getSecondaryName() + "DaoHibernateImpl.java";
    }
    ...
    public boolean equals(Object o) {
        ...
        RelationDaoHibernateImpl that = (RelationDaoHibernateImpl) o;
